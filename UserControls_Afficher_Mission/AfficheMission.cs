...
namespace PimPomBro
{
    ...
    public partial class AfficheMission: UserControl
    {
        ...
        public AfficheMission(int id, String type, String caserne, String date, String heure, String adresse, String status, String motif, String chemin1, String chemin2, String chemin3)
        {
            InitializeComponent();
