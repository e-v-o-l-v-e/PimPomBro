...
namespace MenuPrincipal
{
    public partial class frmTabBord : Form
    {
        ...
        public static void ChargerToutesLesTables()
        {
                ...
                new SQLiteDataAdapter("SELECT * FROM Mission", Connexion.Connec).Fill(MesDatas.DsGlobal, "Mission");
                new SQLiteDataAdapter("SELECT * FROM Caserne", Connexion.Connec).Fill(MesDatas.DsGlobal, "Caserne");
                new SQLiteDataAdapter("SELECT * FROM NatureSinistre", Connexion.Connec).Fill(MesDatas.DsGlobal, "NatureSinistre");
                new SQLiteDataAdapter("SELECT * FROM Admin", Connexion.Connec).Fill(MesDatas.DsGlobal, "Admin");
                new SQLiteDataAdapter("SELECT * FROM Affectation", Connexion.Connec).Fill(MesDatas.DsGlobal, "Affectation");
                new SQLiteDataAdapter("SELECT * FROM Embarquer", Connexion.Connec).Fill(MesDatas.DsGlobal, "Embarquer");
                new SQLiteDataAdapter("SELECT * FROM engin", Connexion.Connec).Fill(MesDatas.DsGlobal, "Engin");
                new SQLiteDataAdapter("SELECT * FROM Grade", Connexion.Connec).Fill(MesDatas.DsGlobal, "Grade");
                new SQLiteDataAdapter("SELECT * FROM Habilitation", Connexion.Connec).Fill(MesDatas.DsGlobal, "Habilitation");
                new SQLiteDataAdapter("SELECT * FROM Mobiliser", Connexion.Connec).Fill(MesDatas.DsGlobal, "Mobiliser");
                new SQLiteDataAdapter("SELECT * FROM Necessiter", Connexion.Connec).Fill(MesDatas.DsGlobal, "Necessiter");
                new SQLiteDataAdapter("SELECT * FROM PartirAvec", Connexion.Connec).Fill(MesDatas.DsGlobal, "PartirAvec");
                new SQLiteDataAdapter("SELECT * FROM Passer", Connexion.Connec).Fill(MesDatas.DsGlobal, "Passer");
                new SQLiteDataAdapter("SELECT * FROM Pompier", Connexion.Connec).Fill(MesDatas.DsGlobal, "Pompier");
                new SQLiteDataAdapter("SELECT * FROM TypeEngin", Connexion.Connec).Fill(MesDatas.DsGlobal, "TypeEngin");
                new SQLiteDataAdapter("SELECT * FROM sqlite_sequence", Connexion.Connec).Fill(MesDatas.DsGlobal, "sqlite_sequence");
